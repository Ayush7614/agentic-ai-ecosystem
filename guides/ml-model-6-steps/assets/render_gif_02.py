#!/usr/bin/env python3
"""Render gif-02-problem-framing.html to high-quality PNG and GIF."""
...
HTML = ROOT / "gif-02-problem-framing.html"
PNG = ROOT / "gif-02-problem-framing.png"
GIF = ROOT / "gif-02-problem-framing.gif"

FPS = 15
DURATION_S = 5.0  # matches 5s CSS animation loop
DEVICE_SCALE = 2  # 2400px wide — blur animations are heavy at 3x
VIEWPORT_W = 1280
VIEWPORT_H = 960
...
def capture_png(out: Path) -> None:
    ...
    with sync_playwright() as p:
        ...
        # Capture at peak clarity (right panel focused)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Render ML problem framing GIF 2")
