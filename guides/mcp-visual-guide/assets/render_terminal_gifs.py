#!/usr/bin/env python3
"""Render MCP Visual Guide terminal GIFs."""
from __future__ import annotations
import shutil, subprocess, sys
from pathlib import Path

ROOT = Path(__file__).resolve().parent
HTML = ROOT / "mcp-terminal.html"
W, H, FPS, SCALE = 1200, 600, 10, 1
STEPS = [
    ("01-install-sdk", "step-01-install-sdk"),
    ("02-scaffold-server", "step-02-scaffold-server"),
    ("03-cursor-config", "step-03-cursor-config"),
    ("04-list-tools", "step-04-list-tools"),
    ("05-test-tool", "step-05-test-tool"),
]
