#!/usr/bin/env python3
"""Render Hermes mega overview GIF — 1200x600, full story in one loop."""
from __future__ import annotations
import shutil, subprocess, sys
from pathlib import Path

ROOT = Path(__file__).resolve().parent
HTML = ROOT / "mega-hermes.html"
OUT = ROOT / "mega-hermes-everything.gif"
W, H, FPS, DUR, SCALE = 1200, 600, 15, 10.0, 1
