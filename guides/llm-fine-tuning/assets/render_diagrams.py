#!/usr/bin/env python3
"""Render LLM fine-tuning diagram GIFs."""
from __future__ import annotations
import shutil, subprocess, sys
from pathlib import Path

ROOT = Path(__file__).resolve().parent
HTML = ROOT / "finetune-diagrams.html"
FPS, SCALE, DUR = 12, 2, 3.0

DIAGRAMS = {
    "landscape": "diagram-landscape.gif",
    "decision-ladder": "diagram-decision-ladder.gif",
    "five-families": "diagram-five-families.gif",
    "peft-menu": "diagram-peft-menu.gif",
    "lora-math": "diagram-lora-math.gif",
    "quantization-ladder": "diagram-quantization-ladder.gif",
    "qlora-stack": "diagram-qlora-stack.gif",
    "rlhf-pipeline": "diagram-rlhf-pipeline.gif",
    "dpo-preference": "diagram-dpo-preference.gif",
    "grpo-loop": "diagram-grpo-loop.gif",
}
...
def gif(did, out):
    ...
    with sync_playwright() as p:
        ...
        page = browser.new_page(viewport={"width": 1160, "height": 400}, device_scale_factor=SCALE)
