#!/usr/bin/env python3
"""Render OpenClaw diagram GIFs (no table visuals)."""
from __future__ import annotations
import shutil, subprocess, sys
from pathlib import Path

ROOT = Path(__file__).resolve().parent
HTML = ROOT / "openclaw-diagrams.html"
FPS, SCALE, DUR = 12, 2, 3.0

DIAGRAMS = {
    "gateway-flow": "diagram-gateway-flow.gif",
    "gateway-arch": "diagram-gateway-arch.gif",
    "workspace": "diagram-workspace.gif",
    "capabilities": "diagram-capabilities.gif",
    "channels": "diagram-channels.gif",
    "skill-levels": "diagram-skill-levels.gif",
    "cron-heartbeat": "diagram-cron-heartbeat.gif",
